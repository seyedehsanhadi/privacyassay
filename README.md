...
```bash
npm test              # 78 checks: scoring arithmetic, every classifier branch, catalog consistency, docs against code
npm run test:browser  # 30 checks in a real browser, including deliberate probe sabotage
